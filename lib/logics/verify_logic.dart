...
class Verify {
  ...
  Future<void> applyForVerifyMobile({
    ...
    Reference ppRef = FirebaseStorage.instance.ref(
        "responders/${FirebaseAuth.instance.currentUser!.uid}/documents/pp.jpg");
    Reference frontRef = FirebaseStorage.instance.ref(
        "responders/${FirebaseAuth.instance.currentUser!.uid}/documents/front.jpg");
    Reference backRef = FirebaseStorage.instance.ref(
        "responders/${FirebaseAuth.instance.currentUser!.uid}/documents/back.jpg");
