...
import '../logics/filepicker.dart';
import '../logics/send_email.dart';
import '../logics/verify_logic.dart';
...
class VerifyResponder extends StatefulWidget {
  const VerifyResponder({super.key});

  @override
  State<VerifyResponder> createState() => _VerifyResponderState();
}

class _VerifyResponderState extends State<VerifyResponder> {
  @override
  Widget build(BuildContext context) {
    String userName = FirebaseAuth.instance.currentUser!.displayName.toString();
    String message =
        "Hi, I am ${FirebaseAuth.instance.currentUser!.displayName} and I am requesting you to verify my identity on Emergency Alert Responder App.\n\nMy Identity is as follows:\n userName: \"$userName\" \n email: \"${FirebaseAuth.instance.currentUser!.email}\" \n uid: \"${FirebaseAuth.instance.currentUser!.uid}\"\n\nPlease verify my identity and send me a message when you are done.\n\nI am applying as Responder Thanks!";
    return SafeArea(
        child: Scaffold(
      appBar: AppBar(
                                  ...
                                  Future<void> proceed() async {
                                    await Verify(context)
                                      ...
                                      await SendEmail(
                                          ...
                                          .forVerification();
                                      Navigator.pop(context);
                                      AwesomeToaster.showAlertDialog(
                                        context: context,
